...
public class PasswordStrongLevel {
    ...
    public static int AwardAdd(String Password){
        int LetterNum=PasswordStrongLevel.LetterAdd(Password);
        int IntegerNum=PasswordStrongLevel.IntegerAdd(Password);
        int SymbolNum=PasswordStrongLevel.SymbolAdd(Password);
